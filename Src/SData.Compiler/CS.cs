...
namespace SData.Compiler
{
    internal static class CS
    {
        ...
        internal static SyntaxTokenList StaticTokenList
        {
            get { return SyntaxFactory.TokenList(StaticToken); }
        }
        ...
        internal static readonly string[] Nullable1NameParts = new string[] { "Nullable`1", "System" };
